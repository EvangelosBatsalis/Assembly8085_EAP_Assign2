...
MOV A, E	;Loads το Α την τιμή LSB του καταχωρητη DE τον E από τον Ζεύγος τον LowOrder
ADD L		;Άθροισμα την τιμή LSB του καταχωρητη HL τον L με τon Ε
...
MOV A, H	;Loads το Α την τιμή MSB του καταχωρητη HL τον H από τον Ζεύγος τον HighOrder
ADC D		;Άθροισμα την τιμή MSB του καταχωρητη DE τον D με τον H από το ζεύγος HL
DAA		;Μετατροπη DAA |27|*****| 4|Decimal Adjust Accumulator| Βάση Τυπολογίου
